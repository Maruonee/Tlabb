...
def make_parser():
    ...
    parser.add_argument("-c", "--weights", dest="ckpt", default=None, type=str, help="checkpoint file")
    ...
    parser.add_argument("-l","--logger",type=str, default='tensorboard' , help="Logger to be used for metrics.  Implemented loggers include `tensorboard` and `wandb`.")
