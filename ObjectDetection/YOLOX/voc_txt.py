...
os.mkdir(f'{root_path}/VOC2007')
os.mkdir(f'{root_path}/VOC2012')
...
VOC2007_path = root_path + 'VOC2007'
VOC2012_path = root_path + 'VOC2012'
print(VOC2007_path)
copy_tree(VOC2007_path, VOC2012_path)