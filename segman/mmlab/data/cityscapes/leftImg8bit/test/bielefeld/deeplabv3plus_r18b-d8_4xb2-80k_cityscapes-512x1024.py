...
launcher = 'none'
load_from = '/home/tlab1004/Tlabb/segman/mmlab/work_dirs/deeplabv3plus_r18b-d8_4xb2-80k_cityscapes-512x1024/iter_80000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='/home/tlab1004/Tlabb/segman/mmlab/runs/test',
    type='IoUMetric')
test_pipeline = [
...
visualizer = dict(
    name='visualizer',
    save_dir='/home/tlab1004/Tlabb/segman/mmlab/runs/test',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '/home/tlab1004/Tlabb/segman/mmlab/data/cityscapes/leftImg8bit/test/bielefeld'
