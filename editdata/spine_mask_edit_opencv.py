...
folder_path = "/home/tlab4090/Tlabb/segman/unet/files/marks/val"
output_folder = "/home/tlab4090/Tlabb/segman/unet/files/marks/out/"
...
for image_name in os.listdir(folder_path):
    if image_name.endswith(('png')):
        ...
        final_img = cv2.resize(gray_img, (512, 512), interpolation=cv2.INTER_LINEAR)
