...
from PyQt5.QtWidgets import (QApplication, QWidget, QLabel, QLineEdit, QPushButton, QVBoxLayout, QHBoxLayout, QFileDialog, QProgressBar, QTextEdit, QGroupBox, QCheckBox, QGridLayout)
...
# Matplotlib FigureCanvas 클래스 정의
class PlotCanvas(FigureCanvas):
    def __init__(self, parent=None, width=5, height=4, dpi=100, title=""):
        ...
        self.ax.plot(np.random.rand(10))  # 초기 랜덤 데이터 표시
...
class DataCollectorApp(QWidget):
    ...
    def initUI(self):
        ...
        self.sound_plot = PlotCanvas(self, title="Sound")  # Sound 그래프
        self.vibration_plot = PlotCanvas(self, title="Vibration")  # Vibration 그래프
        self.voltage_plot = PlotCanvas(self, title="Voltage")  # Voltage 그래프
        self.current_plot = PlotCanvas(self, title="Current")  # Current 그래프
